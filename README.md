...
* Go (version 1.25.3 or higher) installed. [Download Go](https://go.dev/dl/)
* PostgreSQL installed and running, as it is required for all persistent storage.
---

## Commands Overview
After installing and setting up PostgreSQL, you can run gator with the following commands:
